...
public class BasicExamples {
    ...
    public void autoCloseableResponse() {
        ...
        try (Response response = client.target("http://jaxrs.examples.org/jaxrsApplication/customers").request(MediaType.APPLICATION_XML).header("Foo", "Bar")
                .get();) {
            assert response.getStatus() == 200;
        }
    }
    ...
    public void typedResponse() {
        Customer customer = ClientBuilder.newClient().target("http://jaxrs.examples.org/jaxrsApplication/customers/{id}").resolveTemplate("id", 123).request()
                .get(Customer.class);
        assert customer != null;
    }

    public void typedGenericResponse() {
        List<Customer> customers = ClientBuilder.newClient().target("http://jaxrs.examples.org/jaxrsApplication/customers").request()
    ...
    public void asyncResponse() throws Exception {
        Future<Response> future = ClientBuilder.newClient().target("http://jaxrs.examples.org/jaxrsApplication/customers/{id}").resolveTemplate("id", 123)
                .request().async().get();
    ...
    public void typedAsyncResponse() throws Exception {
        Future<Customer> customer = ClientBuilder.newClient().target("http://jaxrs.examples.org/jaxrsApplication/customers/{id}").resolveTemplate("id", 123)
    ...
    public void invocationFlexibility() {
        ...
        Invocation i = ClientBuilder.newClient().target("http://examples.jaxrs.com/greeting").request("text/plain").header("custom-name", "custom_value")
                .buildPut(text("Hi"));
